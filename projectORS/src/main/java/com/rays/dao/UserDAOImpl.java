...
public class UserDAOImpl extends BaseDAOImpl<UserDTO> implements UserDAOInt {
	...
	@Autowired
	protected AttachmentDAOInt attachmentDao;

	public void delete(UserDTO dto, UserContext userContext) {
		super.delete(dto, userContext);
		Long id = dto.getImageId();
		AttachmentDTO attachmentDto = attachmentDao.findByPK(id, userContext);
		attachmentDao.delete(attachmentDto, userContext);
	}
